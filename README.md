...
Semantic HTML gives meaning to contents on a web page. For example, <p> tags symbolize the content within them is a paragraph. People know what paragraphs are and the browser knows how to display them.
...
Because it allows developers to use version control and multiple team members can work on one project and everyone can keep track of what changes have been made and everyone can work off the latest version.


5. Define mobile-first design in your own words.

Mobile-first design is designing in the smallest screen first, for example, a mobile phone then progressing to larger screens like the tablet and desktop. The limited spaces ensure the most important features are implemented.
